"""YouTube DMCA submitter via Playwright."""
...
class PlaywrightYouTubeSubmitter(BaseSubmitter):
    platform = "youtube"
    ...
    async def submit(self, notice: dict[str, Any]) -> dict[str, Any]:
        ...
        if os.getenv("DEMO_MODE", "true").lower() == "true":
            return {
                ...
                "mode": "demo_simulated",
                "message": "DEMO_MODE: simulated YouTube DMCA submission",
            }
        ...
        try:
            ...
            async with async_playwright() as p:
                ...
                await self._fill_common_fields(page, notice, selectors.YOUTUBE)
                submit = page.locator(selectors.YOUTUBE["submit"]).first
